    ...
    ConstraintLayout(Modifier.fillMaxSize()) {
        ...
        Box(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(R.drawable.gems_pic),
                ...
                Text(
                    text = stringResource(R.string.you_earned_25_gems),
                ...
                Text(
                    text = stringResource(R.string.don_t_spend),
                    textAlign = TextAlign.Center,
        ...
        Button(
            ...
            Text(text = stringResource(R.string.awesome),
                fontSize = 16.sp,
